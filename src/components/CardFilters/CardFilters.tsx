      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-warm-800 border border-warm-700 rounded-lg text-sm text-warm-200 placeholder-warm-500 transition-all focus:border-energy focus:ring-2 focus:ring-energy/30 focus:outline-none"
          />
          {filters.searchQuery && (
            <button
